...
```bash
$ brew install nholuongut/tfupdate/tfupdate
```
...
https://github.com/nholuongut/tfupdate/releases
...
```
$ go install github.com/nholuongut/tfupdate@latest
$ tfupdate --version
```
...
```
$ docker run -it --rm nholuongut/tfupdate --version
```
...
https://github.com/nholuongut/tfupdate-circleci-example
