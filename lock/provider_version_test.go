...
func TestProviderVersionMerge(t *testing.T) {
	cases := []struct {
		...
		{
			desc: "merge to empty",
			pv:   newEmptyProviderVersion("nholuongut/dummy", "3.2.1"),
			rhs: &ProviderVersion{
				address:   "nholuongut/dummy",
				version:   "3.2.1",
				platforms: []string{"linux_amd64"},
		...
		},
		{
			...
			pv:   newEmptyProviderVersion("nholuongut/dummy", "3.2.1"),
			rhs:  newEmptyProviderVersion("nholuongut/foo", "3.2.1"),
			want: newEmptyProviderVersion("nholuongut/dummy", "3.2.1"),
			ok:   false,
		},
		{
			desc: "version mismatch",
			pv:   newEmptyProviderVersion("nholuongut/dummy", "3.2.1"),
			rhs:  newEmptyProviderVersion("nholuongut/dummy", "3.2.0"),
			want: newEmptyProviderVersion("nholuongut/dummy", "3.2.1"),
			ok:   false,
		},
		{
